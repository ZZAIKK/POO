...
public:
    ...
    void setupUi(QWidget *graficlientes)
    {
        ...
        graficlientes->resize(328, 321);
        layoutWidget = new QWidget(graficlientes);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(70, 40, 201, 250));
    ...
    {
        graficlientes->setWindowTitle(QCoreApplication::translate("graficlientes", "Form", nullptr));
